...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.ddCitta = ft.Dropdown(label="Citta")
        self.ddLocale1 = ft.Dropdown(label="Locale 1")


        # button for the "creat graph" reply
        self.btn_graph = ft.ElevatedButton(text="Crea Grafo", on_click=self._controller.handle_graph)
        self.btn_Distante = ft.ElevatedButton(text="Locale Distante", on_click=self._controller.handle_localeDistante)
        row1 = ft.Row([self.ddCitta, self.ddLocale1, self.btn_graph, self.btn_Distante],
        ...
        self.ddLocale2 = ft.Dropdown(label="Locale 2")
        self.Soglia = ft.TextField("Soglia")
